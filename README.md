...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ftdz9y4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ftdz9y4.containers.anotherwebservice.com/
...
```
git clone git@github.com:Fiyanshugamer/container-ftdz9y4.git
cd container-ftdz9y4
```
...
```
docker attach container-ftdz9y4
```
